...
class Settings(BaseSettings):
    app_name: str = "CampaignAI"
    debug: bool = False
    database_url: str = "sqlite+aiosqlite:///./data/CampaignAI.db"
    ...
    # Webhook notifications (empty = disabled)
    webhook_slack: str = ""    # Slack incoming webhook URL
    webhook_discord: str = ""  # Discord webhook URL
